...
$JAVA_1_7/java -jar \
$GATK_NIGHTLY/GenomeAnalysisTK.jar \
-T CalculateGenotypePosteriors \
-R $REF_GENOME \
--variant $CORE_PATH/$PROJECT/$MDNA_HASH_ADDRESS/$PROJECT"_MS.vqsr.vcf" \
--supporting $P3_1KG \
--supporting $ExAC \
--disable_auto_index_creation_and_locking_when_reading_rods \
-et NO_ET \
-K $KEY \
-o $CORE_PATH/$PROJECT/$MDNA_HASH_ADDRESS/variants.all.refined.vcf