...
START_TI_TV_RAW=`date '+%s'`

# TI/TV WHOLE GENOME ALL

vcfutils-0.1.18.pl qstats $CORE_PATH/$PROJECT/SNV/SINGLE/WHOLE_GENOME/$SM_TAG".WHOLE.GENOME.SNV.vcf" \
>| $CORE_PATH/$PROJECT/REPORTS/TI_TV/RAW_WG/$SM_TAG"_All_titv.txt"

END_TI_TV_RAW=`date '+%s'`

echo 'TI_TV_WG_RAW,B.01.A.07.A.01,'$START_TI_TV_RAW','$END_TI_TV_RAW >> $CORE_PATH/$PROJECT/REPORTS/run_times.csv
