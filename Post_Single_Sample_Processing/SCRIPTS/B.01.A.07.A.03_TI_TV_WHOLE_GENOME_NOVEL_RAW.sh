...
START_TI_TV_WG_NOVEL_RAW=`date '+%s'`
...
-et NO_ET \
-K $KEY \
--variant $CORE_PATH/$PROJECT/SNV/SINGLE/WHOLE_GENOME/$SM_TAG".WHOLE.GENOME.SNV.RAW.vcf" \
...
END_TI_TV_WG_NOVEL_RAW=`date '+%s'`

echo 'TI_TV_WG_NOVEL_RAW,B.01.A.07.A.03,'$START_TI_TV_WG_NOVEL_RAW','$END_TI_TV_WG_NOVEL_RAW >> $CORE_PATH/$PROJECT/REPORTS/run_times.csv
