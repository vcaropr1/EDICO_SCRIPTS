...
START_TI_TV_CODING_RAW=`date '+%s'`

# TI/TV WHOLE GENOME ALL

vcfutils-0.1.18.pl qstats $CORE_PATH/$PROJECT/SNV/SINGLE/CODING/$SM_TAG".CODING.SNV.vcf" \
>| $CORE_PATH/$PROJECT/REPORTS/TI_TV/RAW_CODING/$SM_TAG"_All_titv.txt"

END_TI_TV_CODING_RAW=`date '+%s'`

echo 'TI_TV_CODING_RAW,B.01.A.08.A.01,'$START_TI_TV_CODING_RAW','$END_TI_TV_CODING_RAW >> $CORE_PATH/$PROJECT/REPORTS/run_times.csv
