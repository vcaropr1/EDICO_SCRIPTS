...
START_TI_TV_WG_KNOWN_RAW_QUAL=`date '+%s'`
...
-o $CORE_PATH/$PROJECT/TEMP/$SM_TAG".WHOLE.GENOME.SNV.LOWQUAL.2.vcf"
...
-et NO_ET \
-K $KEY \
--variant $CORE_PATH/$PROJECT/TEMP/$SM_TAG".WHOLE.GENOME.SNV.LOWQUAL.2.vcf" \
...
>| $CORE_PATH/$PROJECT/REPORTS/TI_TV/RAW_WG/$SM_TAG"_Known_titv.txt"

END_TI_TV_WG_KNOWN_RAW_QUAL=`date '+%s'`

echo 'TI_TV_WG_KNOWN_RAW_QUAL,B.01.A.07.A.02,'$START_TI_TV_WG_KNOWN_RAW_QUAL','$END_TI_TV_WG_KNOWN_RAW_QUAL >> $CORE_PATH/$PROJECT/REPORTS/run_times.csv
