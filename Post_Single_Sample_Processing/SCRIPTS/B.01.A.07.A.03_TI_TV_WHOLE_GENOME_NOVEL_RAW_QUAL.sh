...
START_TI_TV_WG_NOVEL_RAW_QUAL=`date '+%s'`
...
-et NO_ET \
-K $KEY \
--variant $CORE_PATH/$PROJECT/SNV/SINGLE/WHOLE_GENOME/$SM_TAG".WHOLE.GENOME.SNV.vcf" \
-o $CORE_PATH/$PROJECT/TEMP/$SM_TAG".WHOLE.GENOME.SNV.LOWQUAL.3.vcf"
...
-et NO_ET \
-K $KEY \
--variant $CORE_PATH/$PROJECT/TEMP/$SM_TAG".WHOLE.GENOME.SNV.LOWQUAL.3.vcf" \
...
vcfutils-0.1.18.pl qstats $CORE_PATH/$PROJECT/TEMP/$SM_TAG".QC.Novel.TiTv.vcf" >| \
$CORE_PATH/$PROJECT/REPORTS/TI_TV/RAW_WG/$SM_TAG"_Novel_titv.txt"

END_TI_TV_WG_NOVEL_RAW_QUAL=`date '+%s'`

echo 'TI_TV_WG_NOVEL_RAW_QUAL,B.01.A.07.A.03,'$START_TI_TV_WG_NOVEL_RAW_QUAL','$END_TI_TV_WG_NOVEL_RAW_QUAL >> $CORE_PATH/$PROJECT/REPORTS/run_times.csv
