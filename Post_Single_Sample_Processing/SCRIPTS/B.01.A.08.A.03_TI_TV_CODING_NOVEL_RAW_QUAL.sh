...
START_TI_TV_CODING_NOVEL_RAW_QUAL=`date '+%s'`
...
-o $CORE_PATH/$PROJECT/TEMP/$SM_TAG".CODING.SNV.LOWQUAL.3.vcf"
...
-et NO_ET \
-K $KEY \
--variant $CORE_PATH/$PROJECT/TEMP/$SM_TAG".CODING.SNV.LOWQUAL.3.vcf" \
--discordance /isilon/sequencing/GATK_resource_bundle/2.8/b37/dbsnp_138.b37.excluding_sites_after_129.vcf \
-o $CORE_PATH/$PROJECT/TEMP/$SM_TAG".QC.Novel.TiTv.Coding.vcf"

vcfutils-0.1.18.pl qstats $CORE_PATH/$PROJECT/TEMP/$SM_TAG".QC.Novel.TiTv.Coding.vcf" >| \
$CORE_PATH/$PROJECT/REPORTS/TI_TV/RAW_CODING/$SM_TAG"_Novel_titv.txt"

END_TI_TV_CODING_NOVEL_RAW_QUAL=`date '+%s'`

echo 'TI_TV_CODING_NOVEL_RAW_QUAL,B.01.A.08.A.03,'$START_TI_TV_CODING_NOVEL_RAW_QUAL','$END_TI_TV_CODING_NOVEL_RAW_QUAL >> $CORE_PATH/$PROJECT/REPORTS/run_times.csv
