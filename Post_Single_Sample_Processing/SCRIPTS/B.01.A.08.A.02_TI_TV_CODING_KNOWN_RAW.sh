...
START_TI_TV_CODING_KNOWN_RAW=`date '+%s'`
...
END_TI_TV_CODING_KNOWN_RAW=`date '+%s'`

echo 'TI_TV_CODING_KNOWN_RAW,B.01.A.08.A.02,'$START_TI_TV_CODING_KNOWN_RAW','$END_TI_TV_CODING_KNOWN_RAW >> $CORE_PATH/$PROJECT/REPORTS/run_times.csv
