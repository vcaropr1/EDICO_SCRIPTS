...
-o $CORE_PATH/$PROJECT/TEMP/$SM_TAG".WHOLE.GENOME.SNV.LOWQUAL.1.vcf"

# TI/TV WHOLE GENOME ALL

vcfutils-0.1.18.pl qstats $CORE_PATH/$PROJECT/TEMP/$SM_TAG".WHOLE.GENOME.SNV.LOWQUAL.1.vcf" \
>| $CORE_PATH/$PROJECT/REPORTS/TI_TV/RAW_WG/$SM_TAG"_All_titv.txt"

END_TI_TV_RAW_QUAL=`date '+%s'`

echo 'TI_TV_WG_RAW_QUAL,B.01.A.07.A.01,'$START_TI_TV_RAW_QUAL','$END_TI_TV_RAW_QUAL >> $CORE_PATH/$PROJECT/REPORTS/run_times.csv
