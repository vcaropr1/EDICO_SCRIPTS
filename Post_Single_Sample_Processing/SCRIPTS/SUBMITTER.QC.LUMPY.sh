...
SAMPLE_SHEET=$1 # bina style samples sheel with PROJECT,SM_TAG,REF_GENOME,DBSNP
PROJECT=$2

SCRIPT_DIR='/isilon/sequencing/VITO/NEW_GIT_REPO/Whole_Genome_Post_Processing/SCRIPTS/'
