...
-o $CORE_PATH/$PROJECT/VCF/SINGLE/CODING/PASS/$SM_TAG".CODING.PASS.vcf"

END_CODING_PASS=`date '+%s'`

echo 'EXTRACT_VCF_CODING_PASS,B.01.A.04,'$START_CODING_PASS','$END_CODING_PASS >> $CORE_PATH/$PROJECT/REPORTS/run_times.csv
