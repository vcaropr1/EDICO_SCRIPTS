...
START_TI_TV_CODING_NOVEL_RAW=`date '+%s'`
...
END_TI_TV_CODING_NOVEL_RAW=`date '+%s'`

echo 'TI_TV_CODING_NOVEL_RAW,B.01.A.08.A.03,'$START_TI_TV_CODING_NOVEL_RAW','$END_TI_TV_CODING_NOVEL_RAW >> $CORE_PATH/$PROJECT/REPORTS/run_times.csv
