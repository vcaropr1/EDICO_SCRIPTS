...
# qsub -N "A.07.A.01_LUMPY"$RIS_ID"_"$BARCODE_2D \
# -o $CORE_PATH/$PROJECT/LOGS/$SM_TAG".LUMPY.log" \
# -e $CORE_PATH/$PROJECT/LOGS/$SM_TAG".LUMPY.log" \
# $CORE_PATH/$PROJECT/SCRIPTS/A.07.A.01_LUMPY.sh $1 $2 $3 $4 $5 $6
